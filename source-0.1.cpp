// CGPA calculator version 0.2
#include <iostream>
using namespace std;

int main() {
    cout << "------- Generic GPA Calculator --------\n" << endl;
    cout << "# This program is designed to output the CGPA for the courses supplied to it.\n\n" <<
            "# To start, enter the number of courses you wish to evaluate. The program will then serially" <<
            " ask you for 3 inputs (ID, CREDIT, GRADE) for each course.\n\n# The course ID is optional and " <<
            "can be left blank. However, incorrect CREDIT (apart from 0, 1 or 3) or GRADE (A through F, DO NOT ENTER W/Z/I etc.) " <<
            "values will TERMINATE the program.\n\n# GRADE values are CASE INSENSITIVE meaning both B+ and b+ yeild the " <<
            "same result.\n\n# WARNING: Care should be taken as not all inputs are extensively validated.\n\n" << 
            "# TIP: For properper alignment of output table, use consistent naming conventions (eg. CSC121, EEE221 " << 
            "OR CSC 121, EEE 221 OR leave ALL blank)\n\n" << endl;
